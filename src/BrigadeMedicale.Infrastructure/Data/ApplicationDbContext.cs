...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Configure DateTime properties to use UTC kind for PostgreSQL compatibility
        ...
        var nullableDateTimeConverter = new ValueConverter<DateTime?, DateTime?>(
            ...
            v => v.HasValue ? (v.Value.Kind == DateTimeKind.Unspecified ? DateTime.SpecifyKind(v.Value, DateTimeKind.Utc) : v) : null);
